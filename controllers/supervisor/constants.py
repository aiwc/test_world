...
REASON_CODE_ENUM = ['NONE', 'GAME_START', 'SCORE_RED_TEAM', 'SCORE_BLUE_TEAM', 'GAME_END', 'DEADLOCK', 'GOALKICK',
                    'CORNERKICK' 'PENALTYKICK', 'HALFTIME', 'EPISODE_END']
GAME_STATE_ENUM = ['DEFAULT', 'KICKOFF', 'GOALKICK', 'CORNERKICK', 'PENALTYKICK']
ROBOT_FORMATION_ENUM = ['DEFAULT', 'KICKOFF', 'GOALKICK_A', 'GOALKICK_D', 'CAD_AA', 'CAD_AD', 'CAD_DA', 'CAD_DD',
                        'CBC_AA', 'CBC_AD', 'CBC_DA', 'CBC_DD', 'PENALTYKICK_A', 'PENALTYKICK_D']
BALL_POSTURE_ENUM = ['DEFAULT', 'GOALKICK', 'RELOCATION_A', 'RELOCATION_B', 'RELOCATION_C', 'RELOCATION_D',
                     'CORNERKICK', 'PENALTYKICK']
