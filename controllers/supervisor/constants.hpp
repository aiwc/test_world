...
namespace constants {
  ...
  constexpr double      DEFAULT_MAX_METERS_ATTACK = 100.0; // maximum of 100 meters can be run by attackers
  constexpr double      DEFAULT_MAX_METERS_DEFENSE = 80.0; // maximum of 80 meters can be run by defenders
  constexpr double      DEFAULT_MAX_METERS_GOALIE = 60.0; // maximum of 60 meters can be run by the goalie
